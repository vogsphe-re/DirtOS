...
async updateHarvest(id: number, input: UpdateHarvest) : Promise<Result<Harvest | null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_harvest", { id, input }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type Harvest = { id: number; plant_id: number; harvest_date: string; quantity: number | null; unit: string | null; quality_rating: number | null; notes: string | null; asset_id: string | null; sale_ean: string | null; sale_asin: string | null; created_at: string }
...
export type NewHarvest = { plant_id: number; harvest_date: string; quantity: number | null; unit: string | null; quality_rating: number | null; notes: string | null; sale_ean: string | null; sale_asin: string | null }
...
export type NewSeedLot = { species_id: number | null; parent_plant_id: number | null; harvest_id: number | null; lot_label: string | null; quantity: number | null; viability_pct: number | null; storage_location: string | null; collected_date: string | null; source_type: string | null; vendor: string | null; purchase_date: string | null; expiration_date: string | null; packet_info: string | null; ean_code: string | null; sale_ean: string | null; sale_asin: string | null; notes: string | null }
...
export type Plant = { id: number; species_id: number | null; location_id: number | null; environment_id: number; status: PlantStatus; name: string; label: string | null; asset_id: string | null; planted_date: string | null; germinated_date: string | null; transplanted_date: string | null; removed_date: string | null; parent_plant_id: number | null; seed_lot_id: number | null; purchase_source: string | null; purchase_date: string | null; purchase_price: number | null; is_harvestable: boolean; lifecycle_override: string | null; notes: string | null; canvas_object_id: string | null; sale_ean: string | null; sale_asin: string | null; created_at: string; updated_at: string }
...
export type UpdateHarvest = { quality_rating: number | null; notes: string | null; sale_ean: string | null; sale_asin: string | null }
...
export type UpdatePlant = { species_id: number | null; location_id: number | null; status: PlantStatus | null; name: string | null; label: string | null; planted_date: string | null; germinated_date: string | null; transplanted_date: string | null; removed_date: string | null; parent_plant_id: number | null; seed_lot_id: number | null; purchase_source: string | null; purchase_date: string | null; purchase_price: number | null; is_harvestable?: boolean | null; lifecycle_override?: string | null; notes: string | null; sale_ean: string | null; sale_asin: string | null }
...
export type UpdateSeedLot = { species_id: number | null; lot_label: string | null; quantity: number | null; viability_pct: number | null; storage_location: string | null; collected_date: string | null; source_type: string | null; vendor: string | null; purchase_date: string | null; expiration_date: string | null; packet_info: string | null; ean_code: string | null; sale_ean: string | null; sale_asin: string | null; notes: string | null }
